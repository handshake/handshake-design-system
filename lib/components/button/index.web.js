...
var _theme_variable_helper = _interopRequireDefault(require("../../util/theme_variable_helper"));
...
&& {
  ...
  theme,
  type
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.backgroundColor[ghost ? "ghost" : type || "default"].default, theme)};
  ...
  theme,
  type
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.borderColor[ghost ? "ghost" : type || "default"].default, theme)};
    border-radius: ${({
  size,
  theme
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.borderRadius[size || "default"], theme)};
    border-style: ${({
  dashed,
  theme
  ...
  theme,
  type
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.color[ghost ? "ghost" : type || "default"].default, theme)};
    cursor: pointer;
  ...
  size,
  theme
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.fontSize[size || "default"], theme)};
    font-weight: ${({
  theme
}) => theme.btnFontWeight};
    height: ${({
  size,
  theme
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.height[size || "default"], theme)};
    line-height: ${({
  theme
  ...
  size,
  theme
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.padding[size || "default"], theme)};
    padding-left: ${({
  loading,
  size,
  theme
}) => loading ? (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.loadingPaddingLeft[size || "default"], theme) : (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.padding[size || "default"], theme).split(" ")[1]};
    pointer-events: ${({
  loading
}) => loading ? "none" : "auto"};
    position: relative;
  ...
  theme,
  type
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.backgroundColor[ghost ? "ghost" : type || "default"].hover, theme)};
        border-color: ${({
  ghost,
  theme,
  type
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.borderColor[ghost ? "ghost" : type || "default"].hover, theme)};
        color: ${({
  ghost,
  theme,
  type
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.color[ghost ? "ghost" : type || "default"].hover, theme)};
    }
  ...
  theme,
  type
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.backgroundColor[ghost ? "ghost" : type || "default"].focus, theme)};
        border-color: ${({
  ghost,
  theme,
  type
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.borderColor[ghost ? "ghost" : type || "default"].focus, theme)};
        color: ${({
  ghost,
  theme,
  type
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.color[ghost ? "ghost" : type || "default"].focus, theme)};
    }
  ...
  theme,
  type
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.backgroundColor[ghost ? "ghost" : type || "default"].active, theme)};
        border-color: ${({
  ghost,
  theme,
  type
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.borderColor[ghost ? "ghost" : type || "default"].active, theme)};
        color: ${({
  ghost,
  theme,
  type
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.color[ghost ? "ghost" : type || "default"].active, theme)};
    }
    ...
    &[disabled] {
        ...
        &.active {
            background-color: ${({
  theme
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.backgroundColor.disabled, theme)};
            border-color: ${({
  theme
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.borderColor.disabled, theme)};
            box-shadow: none;
            color: ${({
  theme
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.color.disabled, theme)};
            text-shadow: none;
        }
  ...
  size,
  theme
}) => loading ? (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.loadingIconMarginLeft[size || "default"], theme) : 0};
...
_defineProperty(ButtonWrapper, "defaultProps", _objectSpread({
  block: false,
  webHtmlType: "button"
