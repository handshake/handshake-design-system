...
exports.LocaleSubscriber = exports.default = void 0;
...
class LocaleProvider extends _react.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "state", {
      antdLocaleData: {},
      messages: {},
      language: _common.DEFAULT_LANGUAGE,
      localeName: _common.DEFAULT_LOCALE
    });
  }
  ...
  render() {
    return _react.default.createElement(_common.LocaleContext.Provider, {
      value: {
...
const LocaleSubscriber = _common.LocaleContext.Subscriber;
exports.LocaleSubscriber = LocaleSubscriber;