...
&& {
  ...
  size,
  theme
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.dotSize[size || "default"], theme)};
        height: ${({
  size,
  theme
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.dotSize[size || "default"], theme)};
  ...
  size,
  theme
}) => (0, _theme_variable_helper.default)(VARIABLE_LOOKUP.dotSizeI[size || "default"], theme)};
            opacity: 0.3;
            position: absolute;
